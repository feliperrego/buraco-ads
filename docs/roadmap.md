...
| Forma da parcela do lixo (IA9) | spec 0020, 2026-08-05 | **O diagnóstico estava errado no gatilho, e a medição o corrigiu.** Não faltava piso no termo negativo: faltava o **lixo contar como vizinho de si mesmo**. A R4.2 manda o lixo inteiro de uma vez, e a fórmula avaliava cada carta como se ela chegasse sozinha — por isso o erro crescia com o tamanho dele. Maior lixo: **70 → 13**. Pôr piso, a leitura do sintoma, levava só a 24. A força relativa subiu de 97,8% para **100%** |
